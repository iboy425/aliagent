...
# Exp-089：A1 meta-bias + A2 Exp086 联合候选
#
# 只有当 Exp088 审计结果满足条件时才建议使用：
# - best.mean_gain > 0；
# - best.mean_changed 不宜过大；
# - best.min_gain 不能明显为负。
#
# A2 使用 Exp086：严格分群 gate + 中长历史 + 保护 Top1。
...
OUT_DIR="${OUT_DIR:-output/exp089_submit_a1_meta_bias_a2_exp086}"
